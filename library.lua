...
do
	...
	do
		...
		if not isfile(Library.FolderName .. '/Utilities/Hue.png') then
			writefile(Library.FolderName .. '/Utilities/Hue.png', game:HttpGet("https://raw.githubusercontent.com/Ashydrex/testing-scripts/refs/heads/main/hue.png"));
		end;

		if not isfile(Library.FolderName .. '/Utilities/Saturation.png') then
			writefile(Library.FolderName .. '/Utilities/Saturation.png', game:HttpGet("https://raw.githubusercontent.com/Ashydrex/testing-scripts/refs/heads/main/saturation.png"));
		end;

		if not isfile(Library.FolderName .. '/Utilities/Value.png') then
			writefile(Library.FolderName .. '/Utilities/Value.png', game:HttpGet("https://raw.githubusercontent.com/Ashydrex/testing-scripts/refs/heads/main/value.png"));
		end;

		if not isfile(Library.FolderName .. '/Utilities/Shadow.png') then
			writefile(Library.FolderName .. '/Utilities/Shadow.png', game:HttpGet("https://raw.githubusercontent.com/Ashydrex/testing-scripts/refs/heads/main/shadow.png"));
		end;
	...
	local Typeface = loadstring(game:HttpGet("https://raw.githubusercontent.com/Ashydrex/testing-scripts/refs/heads/main/Register.lua"))()
	local LibFont = Typeface:Register("Typefaces", {
		name = "smallest pixel",
		weight = "Regular",
		style = "Normal",
		link = "https://raw.githubusercontent.com/Ashydrex/testing-scripts/refs/heads/main/smallest_pixel-7.ttf",
	}) 
